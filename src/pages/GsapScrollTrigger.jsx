...
const GsapScrollTrigger = () => {
  ...
  useGSAP(
    () => {
      ...
      boxes.forEach((box) => {
        gsap.to(box, {
          ...
          scrollTrigger: {
            trigger: box,
            start: "bottom bottom", // bottom of the box reaches the bottom of the viewport
            end: "top 20%", // it will stop when top of the box reaches 20% of the view port
    ...
    { scope: scrollRef } //use second parameter inorder to know exactly animation needs to happen
  );
